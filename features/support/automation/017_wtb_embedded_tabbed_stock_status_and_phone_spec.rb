...
RSpec.describe "017: Verification of embedded tabbed widget phone number", ps_017_embedded_tabbed: true, ps_embedded_tabbed: true do
begin
  before(:all) do
    puts "017_wtb_embedded_tabbed_local_seller_stock_status_and_phone_test"
