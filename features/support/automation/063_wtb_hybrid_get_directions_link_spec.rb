#This test is to verify the hybrid widget directions
...
RSpec.describe "063: Verification of hybrid dual widget directions", ps_063_hybrid: true, ps_hybrid: true do
begin
  before(:all) do
    puts "063_ps_wtb_hybrid_directions_test"
