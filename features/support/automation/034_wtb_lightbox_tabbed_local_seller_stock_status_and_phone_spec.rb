...
RSpec.describe "034: Verification of lightbox widget phone number", ps_034_lightbox_tabbed: true, ps_lightbox_tabbed: true do
begin
  before(:all) do
    puts "034_wtb_lightbox_tabbed_local_seller_phone_test"
