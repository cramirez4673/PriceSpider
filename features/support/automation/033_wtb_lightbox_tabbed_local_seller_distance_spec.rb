...
RSpec.describe "033: Verification of lightbox widget distance", ps_033_lightbox_tabbed: true, ps_lightbox_tabbed: true do
begin
  before(:all) do
    puts "033_wtb_lightbox_tabbed_local_seller_distance_test"
