#This test is to verify the Mega NE Menu widget directions
...
RSpec.describe "052: Verification of Mega NE Menu widget directions", ps_052_mega: true, ps_mega_ne: true do
begin
  before(:all) do
    puts "052_wtb_mega_ne_menu_local_seller_directions_test"
