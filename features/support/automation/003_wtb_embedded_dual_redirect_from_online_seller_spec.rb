#This test is to verify the embedded dual widget redirect online
...
RSpec.describe "003: Verification of embedded dual widget redirect online", ps_003_embedded_dual: true, ps_embedded_dual: true do
begin
  before(:all) do
    puts "003_wtb_embedded_dual_redirect_online_test"
