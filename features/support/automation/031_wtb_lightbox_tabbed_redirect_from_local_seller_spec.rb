...
RSpec.describe "031: Verification of lightbox widget redirect local", ps_031_lightbox_tabbed: true, ps_lightbox_tabbed: true do
begin
  before(:all) do
    puts "031_ps_wtb_lightbox_tabbed_redirect_local_test"
