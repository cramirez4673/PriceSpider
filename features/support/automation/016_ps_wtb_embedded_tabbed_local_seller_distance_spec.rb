#This test is to verify the embedded tabbed widget distance
...
RSpec.describe "016: Verification of embedded tabbed widget distance", ps_016_embedded_tabbed: true, ps_embedded_tabbed: true do
begin
  before(:all) do
    puts "016_wtb_embedded_tabbed_local_seller_distance_test"
