#This test is to verify the Mega NE Menu widget distance
...
RSpec.describe "053: Verification of Mega Menu widget distance", ps_053_mega: true, ps_mega_ne: true do
begin
  before(:all) do
    puts "053_wtb_mega_ne_menu_local_seller_distance_test"
