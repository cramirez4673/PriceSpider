#This test is to verify the lightbox widget redirect online seller
...
RSpec.describe "021: Verification of lightbox widget redirect from online seller", ps_021_lightbox_dual: true, ps_lightbox_dual: true do
begin
  before(:all) do
    puts "021_wtb_lightbox_dual_redirect_from_online_seller_test"
