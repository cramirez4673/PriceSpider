...
RSpec.describe "028: Verification of the lightbox widget colums", ps_028_lightbox_tabbed: true, ps_lightbox_tabbed: true do
begin
  before(:all) do
    puts "028_wtb_lightbox_tabbed_verify_test"
