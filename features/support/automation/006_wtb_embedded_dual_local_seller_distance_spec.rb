#This test is to verify the embedded dual widget distance
...
RSpec.describe "006: Verification of embedded dual widget distance", ps_006_embedded_dual: true, ps_embedded_dual: true do
begin
  before(:all) do
    puts "006_ps_wtb_embedded_dual_distance_test"
