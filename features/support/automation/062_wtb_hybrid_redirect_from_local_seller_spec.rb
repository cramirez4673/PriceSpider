#This test is to verify the hybrid widget redirect local
...
RSpec.describe "062: Verification of hybrid widget redirect local", ps_062_hybrid: true, ps_hybrid: true do
begin
  before(:all) do
    puts "062_ps_wtb_hybrid_redirect_local_test"
  ...
  if ENV['app_type'] == 'browserstack' and ENV['browser_type'] == 'Edge'
    sleep(5)
    embedded_pg_local_logo_1_image.fire_event :click
  else
