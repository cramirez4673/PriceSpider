#This test is to verify the embedded dual widget dual colums
...
RSpec.describe "001: Verification of embedded dual widget dual colums", ps_001_embedded_dual: true, ps_embedded_dual: true do
begin
  before(:all) do
    puts "001_wtb_embedded_dual_verify_online_and_local_stores_test"
