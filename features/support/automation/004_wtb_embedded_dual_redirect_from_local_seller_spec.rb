#This test is to verify the embedded dual widget redirect local
...
RSpec.describe "004: Verification of embedded dual widget redirect local", ps_004_embedded_dual: true, ps_embedded_dual: true do
begin
  before(:all) do
    puts "004_ps_wtb_embedded_dual_redirect_local_test"
