...
$wtb_demo_product_list_url = "https://demo.pricespider.com/wtb/Demos/WTBO-3247/ZonePerfectMulti/?ps-version=0.0.5.16"

module ProductListWidget
  include RSpec::Matchers
  include Selenium

##########################WTB 2.0 WTB WIDGET##################################

  def launch_ps_demo_product_list
    ...
    if ENV['app_type'] == 'local'
      ...
      @website = ENV['demo_url'] || $wtb_demo_product_list_url
