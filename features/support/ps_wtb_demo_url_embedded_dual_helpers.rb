...
$username2 = "cramir3z7373@gmail.com"
$authkey2 = "u17c0bf93a5fae28"

module EmbeddedDualWidget
...
##########################EMBEDDED DUAL WIDGET##################################
  ...
  def launch_ps_demo_app_embedded_dual_crossbt
    Watir.logger.ignore(:deprecations)
    caps = Selenium::WebDriver::Remote::Capabilities.new
    ...
    caps["screenResolution"] = "1360x768"
    caps["record_video"] = "true"
    caps["record_network"] = "false"
    @browser = Watir::Browser.new(
    :remote,
	:url => "http://#{$username2}:#{$authkey2}@hub.crossbrowsertesting.com:80/wd/hub",
	:desired_capabilities => caps)
  end
